...
contract TestRumSC {
  ...
  function testRumSCUsingDeployedContract() public {
    ...
    uint postCount = rumsc.getLength();

    Assert.isAtLeast(postCount, 0, "Posts length should be a normal number");

    rumsc.save("test","0x2AeF3da35e9A2EC29aE25A04d9C9e92110910A51","PIP:2001","test","test", "0xfbd71db11e7d0038646252e19da21f68befd9db2d79dde02dded74088c2338aa","9ca7c049d6c7b5509951eec902f9145265e666008b15af59f3405295c2a07568569fb6f2235176e9ca8d4ba70eb94c04e656db379774b80a694681e2b0c0bd3300");

    Assert.isAbove(rumsc.getLength(), postCount, "Posts length should greater than pre post count");
    ...
    (id, user_address, protocol, meta, data, hash, signature) = rumsc.posts(postCount);

    Assert.equal(id, "test", "id should be test");
    Assert.equal(user_address, "0x2AeF3da35e9A2EC29aE25A04d9C9e92110910A51", "user_address should be 0x2AeF3da35e9A2EC29aE25A04d9C9e92110910A51");
    ...
    Assert.equal(hash, "0xfbd71db11e7d0038646252e19da21f68befd9db2d79dde02dded74088c2338aa", "hash should be 0xfbd71db11e7d0038646252e19da21f68befd9db2d79dde02dded74088c2338aa");
  ...
  function testRumSCWithNewRumSC() public {
    ...
    Assert.isAbove(rumsc.getLength(), 0, "Posts length should greater than 0");
    ...
    (id, user_address, protocol, meta, data, hash, signature) = rumsc.posts(0);
